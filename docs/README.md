...
- [dataset-generation.md](dataset-generation.md) — how to generate the v5 datasets, including the ~1M-row train set.
...
| Train rows | 1,040,000 (20,000 per task) |
| Eval rows | 104,000 (2,000 per task) |
